from docassemble.base.util import log, action_button_html
...
def docs_list_row( row_label='Document', doc=False ):
  ...
  buttons = [
    action_button_html( doc.pdf.url_for(attachment=True), new_window=False, color="primary", label="Download :file-download:" ),
    action_button_html( doc.pdf.url_for(inline=True), new_window="True", color="primary", label='View <i class="far fa-eye"></i>' )
  ]
